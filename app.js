...
var resultMulti = multiply(multiply(a,b)[0],c)[0];
return [ resultMulti ,"The numbers " + a + "," + b + "," + c + " have a product of " + resultMulti + "." ];
}
multiplyArray([])
...
var firstMulti = multiply(dynamicArray[0], dynamicArray[1]);
var secondMulti = multiply(firstMulti[0], dynamicArray[2]);
var thirdMulti = multiply(secondMulti[0], dynamicArray[3]);
var fourthMulti = multiply(thirdMulti[0], dynamicArray[4]);
...
return('The numbers '+ 'dynamicArray()' + ' have a product of ' + fourthMulti[0]);
}
